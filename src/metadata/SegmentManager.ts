...
export class SegmentManager {
    ...
    public buildTextForModeFromSegments(segments: TextSegment[], includeDebug: boolean): string {
        if (includeDebug) {
     ...
     */
    public buildTextForMode(segments: TextSegment[], includeDebug: boolean): string | null {
        if (!segments) return null;
        return this.buildTextForModeFromSegments(segments, includeDebug);
    }
     ...
     */
    public getDebugSegmentsForDocument(segments: TextSegment[]): DebugSegment[] {
